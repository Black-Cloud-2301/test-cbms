...
const saveStepFourth = async ({page, isNew = false, url, invest = false}: {
    page: Page,
    isNew?: boolean,
    url?: string,
    invest?: boolean
...
const saveStepFifth = async ({page, isNew, url, invest = false}: {
    page: Page,
    isNew?: boolean,
    url?: string,
    invest?: boolean
...
export const evaluate = async ({page, url = ROUTES.BID_EVALUATION, invest = true}: {
    page: Page,
    url?: string,
    invest?: boolean
}) => {
