...
export const createSelectionPlanNewPackageShopping = async (page, mainDialog: Locator, nameSearch?: string, isTCT: boolean = true) => {
    ...
    await selectAutocompleteMulti({
        ...
        value: getAvailableCostSubmission({status: CONTRACTOR_STATUS.APPRAISED, isTCT}).name,
...
export const getAvailableContractorPurchase = ({status, type, index = 0}: {
