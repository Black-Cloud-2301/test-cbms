...
test.describe('test all shopping', () => {
    ...
    test('create cost submission', async ({page}) => {
        await createCostSubmission({page, isTCT});
    ...
    test('create selection_plan/ new package/ shopping full', async ({page}) => {
        test.setTimeout(180000);
        await login(page, ROUTES.KHLCNT_PURCHASE, isTCT ? USERS.NHUNG : USERS.CAM_NHUNG);
        ...
        await createSelectionPlanNewPackageShopping(page, mainDialog, nameSearch, isTCT);
    ...
    test('import document by pid shopping CDT', async ({page}) => {
        ...
        await documentByPidSubmitToAppraiser({
            page,
            invest: false,
            selectContractorForm: SELECT_CONTRACTOR_FORM_TYPE.CDT
        });
    ...
    test('import document by pid shopping HDTT', async ({page}) => {
        ...
        await documentByPidSubmitToAppraiser({
            page,
            invest: false,
            selectContractorForm: SELECT_CONTRACTOR_FORM_TYPE.HDTT
        });
